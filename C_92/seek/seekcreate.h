...
static unsigned short pkzip_bits[] = {
#include "/local/openwin30/share/include/images/Pkzip_glyph.icon"
};

static unsigned short dos_bits[] = {
#include "/local/openwin30/share/include/images/DOSwin_glyph.icon"
};
...
extern Notify_value seek_event_hand2
( 
Panel panel, Event *event, Notify_arg arg, Notify_event_type type
); 
