...
extern  Panel_item      primebutton, secondbutton, done_button, filter_button, grab_word, propsOn, quit_button, prime_toCurr, second_toCurr, up_button, down_button;
...
extern int	ff_dir, ff_file, ff_lnk, ff_chr, ff_sock, ff_fifo, ff_empty, ff_core, ff_compressed, ff_icon, ff_csource, ff_object, ff_header, ff_exe, ff_aml, ff_sound, ff_ps, ff_rast, ff_mail, ff_shell, ff_wp, ff_bm, ff_gif, ff_make, ff_info, ff_lib, ff_gis, ff_im, ff_gra, ff_plt, ff_XRe, ff_XRs, ff_XRh, ff_XRd, ff_XRr, ff_dos, ff_pkzip;

extern	Server_image	seek_icon, seek_icon2, seek_icon3, mask_icon, file_icon, dir_icon, sys_icon, link_icon, pipe_icon, sock_icon, core_icon, compressed_icon, csource_icon, object_icon, header_icon, exe_icon, aml_icon, sound_icon, ps_icon, rast_icon, mail_icon, shell_icon, wp_icon, bm_icon, gif_icon, make_icon, info_icon, lib_icon, gis_icon, im_icon, gra_icon, plt_icon, vi_icon, XRe_icon, XRs_icon, XRh_icon, XRd_icon, XRr_icon, empty_icon, dos_icon, pkzip_icon;
