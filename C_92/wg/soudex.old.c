...
#ifdef SPARC
static const char cFileID[] = "@(#)soundex.c	1.1:/local/misc/C/spellit/SCCS/s.soundex.c	7/21/93 10:13:55";
#endif
...
/* main()
{
    ...
    assert(comp(s1,s1) == BITS_IN_SHORT);
    assert(comp(s2,s2) == BITS_IN_SHORT);
