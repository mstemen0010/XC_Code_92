...
*/
	  ...
	  color_choice = (Panel_item) xv_create (proppanel, PANEL_CHOICE,
			    ...
			    PANEL_ITEM_COLOR,			 CMS_CONTROL_COLORS + SUPPORTCOLOR,
    			PANEL_LABEL_STRING, "Phonetool color buttons classed by type : ",
    ...
    dialpanel = (Panel) xv_create (dialframe, PANEL, 
			...
			(Panel_item) xv_create (dialpanel, PANEL_MESSAGE, 
                ...
                WIN_Y,      			0,  
    			PANEL_READ_ONLY, TRUE,
				PANEL_LABEL_STRING,	"This feature allows you to dial a number by typing in a number,",
                NULL);
			...
			(Panel_item) xv_create (dialpanel, PANEL_MESSAGE, 
                ...
                WIN_Y,      			15,  
    			PANEL_READ_ONLY, TRUE,
				PANEL_LABEL_STRING,	"and pressing the \"Auto Dial number\" button. ",
                NULL);
    ...
    /*            FRAME_DONE_PROC,    nullfunct,   */
		...
		info_helptw =	(Textsw) xv_create (helpframe, TEXTSW,
					WIN_CMS,				phonetoolcms,
						...
						WIN_ROWS, 				5,
						WIN_COLUMNS,   			60,
						TEXTSW_CONTENTS, "Phonetool allows you query a company phonelist, or a personal one. In addition to this it also allows you to edit your personal phone list, and allows you to get customized phone list which you can re format in your favorite word processor via a flat file.",
						NULL);
       ...
       helppanel3 = (Panel) xv_create (helpframe, PANEL,
		...
		color_helptw = (Textsw) xv_create (helpframe, TEXTSW,
		   		...
		   		WIN_BACKGROUND_COLOR,	CMS_CONTROL_COLORS + SCREENCOLOR, 
                        ...
                        WIN_ROWS, 5,
                        WIN_COLUMNS,   60,
						TEXTSW_CONTENTS, "The colors are changable because you will not always have the same root window, and panel colors in your environment. This feature allows you to set these as you wish. The 'classes' refer to the way certain items are grouped together. This is because these items have a relation to one another. Remember, once you have your colors set to your liking, hit 'Apply' to save them permanently.",
					NULL);
