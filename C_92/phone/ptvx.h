...
Panel           panel, addpanel, updtxtpanel, updpanel, proppanel, querypanel, 
...
Server_image        phonebook_icon, mask_icon, phone_image, phword_image, 
					bkword_image, head_phone_image, speaker_image, null_image, play_image;
